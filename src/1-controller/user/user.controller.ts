...
export class UserController {
  ...
  async getById(@Param(RouteParamEnum.idUser) idUser: string): Promise<UserViewModel> {
    return UserEntityToUserViewModelMapper.map(await this.userService.getById(idUser));
  }
