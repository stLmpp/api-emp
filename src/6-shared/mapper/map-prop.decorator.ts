...
export function MapProp(typeFn?: () => any): PropertyDecorator {
...
function getPropertiesMetadataMapped(target: Class<any>): PropertyMetadata[] {
...
export function getPropertiesMetadata<T>(target: Class<T>): PropertyMetadata<T>[] {
